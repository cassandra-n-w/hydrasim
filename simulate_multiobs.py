...
# NOTE: this file was copy-pasted from simulate_obs_hydra. this was rather lazy and not future-proof
...
for seedmod in np.arange(0, 15):
    ...
    for night in range(0, 1):
        ...
        if (apply_noise):
                ...
                sm.setseed(seed=int(10001 + night + seedmod))
                sm.setnoise(
                    mode = 'tsys-manual',
    ...
    np.save(str(int(noiselev*1000)) + "mjy/means" + str(seedmod) + file + ".npy", means)
